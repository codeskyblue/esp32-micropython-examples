# copy from https://github.com/redoxcode/micropython-servo/blob/main/src/servo/__init__.py
# min_us, max_us modified to 500-2500
import machine
import math

class Servo:
    def __init__(self,pin_id,min_us=500.0,max_us=2500.0,min_deg=0.0,max_deg=180.0,freq=50):
